export const palette = {
  ...
  muted: "#94a8c2",
  accent: "#56d0e0",
  accentSoft: "rgba(86, 208, 224, 0.14)",
  accentMedium: "rgba(86, 208, 224, 0.24)",
  accentStrong: "#2e93a8",
  accentGlow: "rgba(86, 208, 224, 0.35)",
  success: "#5ee6a0",
  successSoft: "rgba(94, 230, 160, 0.12)",
  warning: "#ffb347",
  ...
  cardGlow: "rgba(86, 208, 224, 0.06)",
  glass: "rgba(13, 20, 36, 0.82)",
  glassBorder: "rgba(148, 180, 224, 0.12)",
  card: "rgba(13, 20, 36, 0.92)",
};
